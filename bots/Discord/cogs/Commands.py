...
class Commands(commands.Cog, name= "lidarhd" ):
    ...
    @commands.command(name="status", describes="gets the output status of the compute job")
    @app_commands.guilds(discord.Object(id='918859383809671198'))
    ...
    @commands.command(name="surface_reconstruction", description="takes the 3D point cloud in las format and generates the corresponding polygon representation of file in ply format")
    @app_commands.guilds(discord.Object(id='918859383809671198'))
